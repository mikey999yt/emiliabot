...
`.trim(), 'EMILIA BOT', 'Bot Owner', ',owner', m)
    }
    ...
    if (new Date() * 1 - setting.status > 1000) {
        ...
        await this.setStatus(`𝐔𝐩𝐭𝐢𝐦𝐞 ${uptime} | 𝐌𝐨𝐝𝐞: ${global.opts['𝐒𝐞𝐥𝐟'] ? '𝐏𝐫𝐢𝐯𝐚𝐭𝐞' : setting.groupOnly ? '𝐆𝐫𝐨𝐮𝐩 𝐎𝐧𝐥𝐲' : '𝐏𝐮𝐛𝐥𝐢𝐜'} | DitzzSenpai`).catch(_ => _)

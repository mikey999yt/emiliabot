...
const defaultMenu = {
  before: `
Hai, %name!
Homepage: https://bot.wibusoft.cloud
%readmore`.trimStart(),
  header: '┌─ %category',
  body: '├ %cmd',
  footer: '└────\n',
  after: `
*%npmname🌟*
${'```If Bot Offline Just Click Link Below```'}
`,
}
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  ...
  try {
          ...
          "sections": [
            {
              "rows": [
                ...
                "rowId": ".? anime"
                  ...
                  "title": "𝐐𝐮𝐨𝐭𝐞𝐬",
                  "description": "Gives You Random Quotes..🗣️",
                  "rowId": ".? quotes"
                }, {
                  "title": "𝐀𝐝𝐦𝐢𝐧",
                  ...
                  "title": "𝐏𝐫𝐞𝐦𝐢𝐮𝐦",
                  "description": "Premium Users Plugins🗡️",
                  "rowId": ".? premium"
                }, {
                  "title": "𝐈𝐧𝐭𝐞𝐫𝐧𝐞𝐭",
                  ...
                  "title": "𝐍𝐮𝐥𝐢𝐬 & 𝐋𝐨𝐠𝐨",
                  "description": "Text Maker Commands〽️",
                  "rowId": ".? nulis"
                }, {
                  "title": "𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐞𝐫",
                  ...
                  "title": "𝐃𝐚𝐭𝐚𝐛𝐚𝐬𝐞",
                  "description": "User database〽️",
                  "rowId": ".? database"
                }, {
                  "title": "𝐈𝐧𝐟𝐨",
                  "description": "To find out BOT info🗡️",
                  "rowId": ".? info"
                }, {
                  "title": "𝐎𝐰𝐧𝐞𝐫",
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch("https://telegra.ph/file/fb6c8346c7eb7297e5572.jpg")).buffer(), text.trim(), 'https://bot.wibusoft.cloud', '𝐎𝐰𝐧𝐞𝐫 𝐁𝐨𝐭', ',owner', '𝐀𝐥𝐥 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬', '.? all', m)
  } catch (e) {
